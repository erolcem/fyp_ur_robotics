...
class MoveItik(object):
    def __init__(self):
        ...
        # self.component_output.close() 
        # self.go_home()
        # self.observe_MC_front_higher(31)
        # self.mir_calibrate_tag(31)
        # self.MC2()
        # self.webdriver.edit_and_run(0.670, -0.1, 0)
        # self.observe_MC_front_higher(33)
        # self.mir_calibrate_tag(33)
        # self.CC4()

        # self.observe_MC_front_higher_higher(33)
        # self.mir_calibrate_tag(33)
        # self.MC3()

        # self.webdriver.edit_and_run(0.550, 0, 0)
        # self.observe_MC_front_higher(35)
        # self.mir_calibrate_tag(35)
        # self.CC5()
        # self.observe_MC_front_higher_higher_higher(35)
        # self.mir_calibrate_tag(35)
        # self.MC4()

        # self.webdriver.edit_and_run(0.550, 0, 0)
        # self.observe_MC_front_higher(37)
        # self.mir_calibrate_tag(37)
        # self.CC6()
        self.observe_MC_front_higher_higher(37)
        self.mir_calibrate_tag(37)
        self.MC5()
        # self.raise_up(0.100, 2.56, 0.6)
    ...
    def CC3(self):
        ...
        rospy.sleep(1)
        self.go_storage(1.6,0,0.7)
        self.install_CC(0.2792,0.120,0.320,0.230,0.225)
        self.insert_CC(0.2792,0.120,0.320,0.230,0.225,0.070)
    ...
    def CC4(self):
        ...
        rospy.sleep(1)
        self.go_storage(1.6,0,0.7)
        self.install_CC(0,0.225,0.305,0.285,0.16)
        self.insert_CC(0,0.225,0.305,0.285,0.16,0.04)
        # self.talktorobot(self.ip_robotA)
        # self.listentorobot(self.ip_robotB)
        # self.raise_up(0.150, 1.96, 0.526)
    ...
    def CC5(self):
        ...
        rospy.sleep(1)
        self.go_storage(1.6,0,0.7)
        self.install_CC(-0.1,0.175,0.305,0.425,0.15)
        self.insert_CC(-0.1,0.190,0.305,0.425,0.15,0.06)
        self.gripper_rg6.opengripper_fast()
        self.go_reference_CC_higher()
        self.go_home()
    def CC6(self):
        ...
        rospy.sleep(1)
        self.go_storage(1.6,0,0.7)
        self.install_CC(-0.35,0.12,0.305,0.48,0.12)
        self.insert_CC(-0.35,0.12,0.305,0.48,0.12,0.045)
        self.gripper_rg6.opengripper_fast()
        self.go_reference_CC_higher()
        self.go_home()
    def MC1(self):
        ...
        rospy.sleep(1)
        self.go_storage(1.6,0,0.7)
        self.preinstall_MC(0,0.105,0.7,0.315)
        self.install_MC(0,0.105,0.4,0.315,0.05)
        self.insert_MC(0.1703, 0, 0.07,0.4,0.315,0.05,0.65,0.24) #self.origin_position.pose.position.z-z
        self.write_down(self.component_output)
        self.gripper_rg6.opengripper_fast()
        self.go_reference_CC()
        self.go_home()
    def MC2(self):
        ...
        rospy.sleep(1)
        self.go_storage(1.6,0,0.7)
        self.preinstall_MC(0.2792,-0.085,0.8,0.65)
        self.install_MC(0.2792,-0.085,0.440,0.45,0.05)
        self.insert_MC(0.0, -0.2792, -0.1,0.44,0.45,0.05,0.65,0.38) #self.origin_position.pose.position.z-z
        self.gripper_rg6.opengripper_fast()
        self.go_reference_CC_higher()
        self.go_home()
    def MC3(self):
        ...
        rospy.sleep(1)
        self.go_storage(1.6,0,0.7)
        self.preinstall_MC(0.35,0.08,0.8,0.65)
        self.install_MC(0.35,0.08,0.425,0.375,0.1)
        self.insert_MC(-0.18, -0.35, 0.075,0.425,0.375,0.1,0.65,0.38) #self.origin_position.pose.position.z-z
        self.gripper_rg6.opengripper_fast()
        self.go_reference_CC_higher_higher()
        self.go_home()
    def MC4(self):
        ...
        rospy.sleep(1)
        self.go_storage(1.6,0,0.7)
        self.preinstall_MC(0.45,0.08,0.8,0.75)
        self.install_MC(0.45,0.08,0.43,0.4,0.04)
        self.insert_MC(-0.34, -0.45, 0.075,0.43,0.4,0.04,0.65,0.38) #self.origin_position.pose.position.z-z
        self.gripper_rg6.opengripper_fast()
        self.go_reference_CC_higher_higher()
        self.go_home()
    def MC5(self):
