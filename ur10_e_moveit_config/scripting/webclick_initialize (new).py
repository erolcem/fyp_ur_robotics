...
class fwebdriver(object):
	def __init__(self):
		...
		print("edit trial")
		self.driver.find_element_by_xpath("/html/body/div[7]/div[2]/div[2]/div[1]/div[2]/div[4]/div[5]").click()
		time.sleep(1)

		print("begin editing data")
		self.driver.find_element_by_xpath("/html/body/div[7]/div[2]/div[2]/div[3]/ul/li/div/div[3]").click()
	...
	def edit_and_run(self, distancex, distancey, angle):
		...
		# here is the mission panel
		print("Run")
		self.driver.find_element_by_xpath("/html/body/div[7]/div[2]/div[2]/div[1]/div[2]/div[4]/div[3]").click()
