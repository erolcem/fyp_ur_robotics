...
class MoveItik(object):
    def __init__(self):
        ...
        self.back_home() #Back to initial place
        self.go_home() #Back to initial place
        self.go_storage() #detect
        self.readfile(self.object_target) #know where to go from the camera data
        self.go_target() #go!
        #self.test()
    ...
    def readfile(self, position):
        ...
        os.system('/home/cheavporchea/ur10e_paving/src/ur10_e_moveit_config/scripting/tutorial-mb-generic-tracker-rgbd-realsense --model_color model/brick/brickstack/brick-stack.cao')
        rospy.sleep(5)
        os.system('pkill tutorial-mb-generic-tracker-rgbd-realsense')
