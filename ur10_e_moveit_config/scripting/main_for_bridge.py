...
class MoveItik(object):
    def __init__(self):
        ...
        rospy.sleep(1)
        self.ref_pos_output = open("/home/cheavporchea/ur10e_paving/src/ur10_e_moveit_config/scripting/ref_pos.out","w")
        self.MC_output = open("/home/cheavporchea/ur10e_paving/src/ur10_e_moveit_config/scripting/grab_pos.out","w")
        self.ref_rot_output = open("/home/cheavporchea/ur10e_paving/src/ur10_e_moveit_config/scripting/ref_rot.out","w")
        self.output = open("/home/cheavporchea/ur10e_paving/src/ur10_e_moveit_config/scripting/result.out","w")
        self.output = open("/home/cheavporchea/ur10e_paving/src/ur10_e_moveit_config/scripting/result.out","w")
        self.output_angle = open("/home/cheavporchea/ur10e_paving/src/ur10_e_moveit_config/scripting/angle_result.out","w")
        t0 = timeit.default_timer()
        # self.CC_output.write("================ CC2 ================="+"\n")
        # self.MC_output.write("================ MC1 ================="+"\n")
        # self.ref_rot_output.write("================ CC2 ================="+"\n")
        ...
        # t = t1-t0
        # self.output.write("Duration ="+ str(t))
        # self.ref_pos_output.close() 
        # self.grab_pos_output.close() 
        # self.ref_rot_output.close() 
    ...
    def callback(self, position):
        ...
        print(str(self.object_target.pose.pose.pose.position.z*1000)+"\n")
    def calibrate(self):
        ...
        target_pose.pose.orientation.z = self.object_target.pose.pose.pose.orientation.z
        target_pose.pose.orientation.w = self.object_target.pose.pose.pose.orientation.w
        self.pos_x = self.object_target.pose.pose.pose.position.x
        self.pos_y = self.object_target.pose.pose.pose.position.y
