...
class ImageRecognition(object):
    ...
    def __init__(self):
        ...
        try:
            self.sub_depth = rospy.Subscriber("/camera/aligned_depth_to_color/image_raw", Image, self.convert_depth_image, queue_size=10, buff_size=152428800)
    ...
    def select_target(self):
        ...
        cv2.line(self.rgb_array,(640/2,0),(640/2,480),(0,0,255), 1)
        cv2.line(self.rgb_array,(0,480/2),(640,480/2),(0,0,255), 1)
        ...
        for contour in contours:
            ...
            if cv2.contourArea(contour) > 100:
              ...
              #  roty = rot_y + self.camera2hand[5]
                center_strXY = str(int(mass_centre_x)) + ',' + str(int(mass_centre_y)) + ',' + str(self.depth_array[int(mass_centre_y)][int(mass_centre_x)])
